...
<body class="p-5">
	...
	<div class="containter-fluid">
		<form:form method="GET"
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<textarea rows="4" cols="50" class="form-control"
						name="contractDesc" placeholder="Contract Description"
						minlength="4" maxlength="50" tabindex="1" autofocus></textarea>
				</div>
			</div>
			<div class="form-group row">
			...
			<div align="center">
				<button type="submit" class="btn btn-outline-success" tabindex="6">Submit</button>
